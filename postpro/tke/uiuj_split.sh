if [[ $1 == "-h" ]]
then
    echo "Uses uiuj to calculate statistics on a subrange of the whole set of snapshots. All available snapshots are however used to calculate the mean velocity field. Syntax:"
    echo
...
#    pycode="import numpy as np; filez = [$filelist]"'\n
#print(filez)
...
# output file
cumulative.tofile('profiles/uiuj.bin')
